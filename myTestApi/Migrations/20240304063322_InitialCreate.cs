        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_Countries_CountrysId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemenOwner", x => new { x.OwnerId, x.PokemonId });
                    table.ForeignKey(
                        name: "FK_PokemenOwner_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemenOwner_Pokemons_PokemonId",
                        column: x => x.PokemonId,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_CountrysId",
                table: "Owners",
                column: "CountrysId");

            migrationBuilder.CreateIndex(
                name: "IX_PokemenOwner_PokemonId",
                table: "PokemenOwner",
                column: "PokemonId");
